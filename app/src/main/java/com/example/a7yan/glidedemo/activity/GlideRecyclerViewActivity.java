...
public class GlideRecyclerViewActivity extends Activity
{
    ...
    private GlideRecyclerViewAdapter<RecyclerView.ViewHolder> glideRecyclerViewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        glideRecyclerViewAdapter = new GlideRecyclerViewAdapter<RecyclerView.ViewHolder>(this);
